...
describe('Result type utilities', function () {
    ...
    describe('wrap', function () {
        it('should wrap successful promise', function () {
        ...
        it('should wrap failed promise', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var promise, result
                var _a
        ...
        it('should handle promise rejection with non-Error objects', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var promise, result
                var _a
                return __generator(this, function (_b) {
        ...
        it('should handle async errors in error mapping function', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var promise, result
                var _a
                return __generator(this, function (_b) {
        ...
        it('should handle null/undefined promise values', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                wrap(nullPromise, function (e) {
                                    return new FetchError({ message: e.message, retry: false })
                                })
                            ]
                        case 1:
                            nullResult = _a.sent()
                            ...
                            return [
                                4 /*yield*/,
                                wrap(undefinedPromise, function (e) {
                                    return new FetchError({ message: e.message, retry: false })
                                })
                            ]
                        case 2:
    ...
    describe('Result type usage patterns', function () {
        ...
        it('should handle successful chain of operations', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var result
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        it('should handle failed chain of operations', function () {
            return __awaiter(void 0, void 0, void 0, function () {
                var result
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [4 /*yield*/, fetchData(false)]
                        case 1:
                            result = _a.sent()
                            if (result.err) {
