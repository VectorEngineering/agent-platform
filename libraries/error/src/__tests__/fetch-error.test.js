...
describe('FetchError', function () {
    ...
    describe('HTTP methods', function () {
        it.each(['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'HEAD', 'OPTIONS'])('should handle %s requests', function (method) {
            var _a
            var error = new FetchError({
    ...
    describe('context handling', function () {
        ...
        it('should handle various header combinations', function () {
            ...
            expect(
                (_b = (_a = error.context) === null || _a === void 0 ? void 0 : _a.headers) === null || _b === void 0
                    ? void 0
                    : _b['Content-Type']
            ).toBe('application/json')
            expect(
                (_d = (_c = error.context) === null || _c === void 0 ? void 0 : _c.headers) === null || _d === void 0
                    ? void 0
                    : _d['Authorization']
            ).toBe('Bearer token')
        })
