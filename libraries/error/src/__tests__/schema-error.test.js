...
describe('SchemaError', function () {
    ...
    describe('fromZod', function () {
        ...
        it('should handle missing required fields', function () {
            ...
            expect(JSON.parse((error === null || error === void 0 ? void 0 : error.message) || '')).toEqual(
    ...
    describe('error handling', function () {
        ...
        it('should work with async/await error handling', function () {
    ...
    describe('context handling', function () {
        it('should handle non-serializable data', function () {
            ...
            expect(function () {
                var _a
                return JSON.stringify((_a = error.context) === null || _a === void 0 ? void 0 : _a.raw)
            }).toThrow()
        })
